...
use frame_support::{
	...
	parameter_types,
	traits::{
		ConstU16, ConstU32, Currency, EnsureOneOf, EqualPrivilegeOnly, Everything, Imbalance,
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("cere-dev-node"),
	impl_name: create_runtime_str!("cere-development-node"),
