//! ISMP / hyperbridge wiring for the Cere-dev runtime.
//!
...
parameter_types! {
	...
	// `id` field of the ChainSpec. cere-dev uses the same identifier as
	// cere so transfers across the two networks share an envelope shape.
