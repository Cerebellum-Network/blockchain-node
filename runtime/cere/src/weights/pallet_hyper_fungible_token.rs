...
// --repeat
// 20
// --output=./runtime/cere-dev/src/weights/pallet_hyper_fungible_token.rs
...
/// Weights for pallet_hyper_fungible_token using the Substrate node and recommended hardware.
pub struct SubstrateWeight<T>(PhantomData<T>);
impl<T: polkadot_sdk::frame_system::Config> pallet_hyper_fungible_token::WeightInfo for SubstrateWeight<T> {
