...
use ink::env::{
	call::{ExecutionInput, Executor},
	Environment,
};

pub type AccountIdOf<R> = <R as frame_system::Config>::AccountId;
pub type BalanceOf<R> = <<R as pallet_contracts::Config>::Currency as Inspect<
	...
	R: pallet_contracts::Config,
{
		...
		Output: codec::Decode,
	{
		...
		let result = codec::Decode::decode(&mut &output[..])
			.map_err(|_| sp_runtime::DispatchError::Other("Failed to decode contract output"))?;
