...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn bond() -> Weight {
		Weight::from_parts(140_774_000_u64, 0)
	...
	fn unbond() -> Weight {
		Weight::from_parts(94_017_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(7_u64))
	...
	fn withdraw_unbonded() -> Weight {
		Weight::from_parts(78_227_000_u64, 0)
	...
	// Proof: `DdcStaking::LeavingStorages` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn store() -> Weight {
		Weight::from_parts(63_008_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
	...
	// Proof: `DdcClusters::ClustersGovParams` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn chill() -> Weight {
		Weight::from_parts(46_888_000_u64, 0)
	...
	// Proof: `DdcStaking::Ledger` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn set_controller() -> Weight {
		Weight::from_parts(34_917_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	...
	// Proof: `DdcStaking::LeavingStorages` (`max_values`: None, `max_size`: None, mode: `Measured`)
	fn set_node() -> Weight {
		Weight::from_parts(36_498_000_u64, 0)
	...
	fn fast_chill() -> Weight {
		Weight::from_parts(55_455_000_u64, 0)
	...
	// Proof: `Balances::Freezes` (`max_values`: None, `max_size`: Some(67), added: 2542, mode: `MaxEncodedLen`)
	fn bond_cluster() -> Weight {
		Weight::from_parts(93_355_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(5_u64))
	...
	// Proof: `System::Account` (`max_values`: None, `max_size`: Some(128), added: 2603, mode: `MaxEncodedLen`)
	fn unbond_cluster() -> Weight {
		Weight::from_parts(93_475_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(6_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
	// Storage: `DdcClusters::Clusters` (r:1 w:1)
	...
	// Proof: `Balances::Freezes` (`max_values`: None, `max_size`: Some(67), added: 2542, mode: `MaxEncodedLen`)
	fn withdraw_unbonded_cluster() -> Weight {
		Weight::from_parts(136_857_000_u64, 0)
			.saturating_add(T::DbWeight::get().reads(5_u64))
			.saturating_add(T::DbWeight::get().writes(4_u64))
	}
}
