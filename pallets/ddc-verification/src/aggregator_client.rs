...
=======
	verify_sig: bool,
>>>>>>> 0611423d (Error on JSON signature verification failure)
}
...
>>>>>>> f6a9561b (Use protobuf generated definitions)
=======
    pub base_url: &'a str,
    timeout: Duration,
=======
...
>>>>>>> e157006b (cargo fmt)
=======
>>>>>>> 54e22263 (Retries for aggregator challenge requests)
}
...
>>>>>>> b9218642 (Add aggregator response wrapper with a signature)
	}
}
